...
![alt text](image.png)
6. Buka Projek Company himafor_nim
7. Bagi 2 Folder untuk projek Web App Statis dan Dinamis
8. Move file index dan Dcoker milik web statis ke Folder web-statis
9. Copy Folder Projek Next.JS (pertemuan9)ke folder web-dinamis
10. Lakukan Testing di Local Project Next.JS
...
19. Cek di AWS, apakah container berjalan dengan baik
![alt text](image-5.png)
20. Akses web melalui Browser login admin edit Layanan
